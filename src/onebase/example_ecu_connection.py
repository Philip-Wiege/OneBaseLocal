...
InstanceECUConnection680 = ECUConnection(paramTXAddress=0x680, paramRXAddress=0x690, paramConnectionType="Telnet", paramConnectionInterface="rfc2217://10.0.1.137:5000", paramFilepathDIDList="BV_OneBase_DIDs.json")
